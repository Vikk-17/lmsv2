        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
          <div class="flex justify-between items-center">
            ...
            <button
              ...
              type="button"
              class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-button bg-[var(--clr-accent-900)] text-white hover:bg-[var(--clr-accent-1000)] focus:outline-none whitespace-nowrap"
            >
              ...
              <div class="p-4 bg-white">
                <div class="space-y-3">
                  ...
                  <button
                    ...
                    type="button"
                    class="flex items-center justify-center w-full p-3 border border-dashed border-gray-300 rounded-md text-sm font-medium text-primary hover:bg-indigo-50 focus:outline-none"
                  >
