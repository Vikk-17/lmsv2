            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  type="text"
                  id="course-title"
                  class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--clr-accent-900)] focus:border-transparent outline-none"
              ...
              <div>
                ...
                <div class="relative">
                  <select
                    id="course-language"
                    class="w-full p-2.5 border border-gray-300 rounded-lg appearance-none focus:ring-2 focus:ring-[var(--clr-accent-900)] focus:border-transparent outline-none pr-8"
                  >
