...
import StuMyCourseSec from "../components/UI/components/StuMyCourseSec";
          ...
          <div className="flex flex-col gap-y-8">
            ...
            <div role="tablist" className="flex  bg-white text-xl rounded-xl">
              <button
                ...
                id="tab-1"
                className="py-4 px-6 border-b-2 bg-[var(--clr-accent-200)] text-[var(--clr-accent-900)] rounded-tl-xl rounded-bl-xl"
              >
                All
              </button>
              <button
                ...
                id="tab-2"
                className="py-4 px-6 hover:bg-[var(--clr-accent-200)] "
              >
                Active
              </button>
              <button
                ...
                <div className="flex-1 flex flex-col gap-y-8">
                  <div className="flex justify-between">
                    <div className="w-full max-w-xs">
                      ...
                      <p>
                        Learn to create stunning visuals and designs
                        professionally.
                      </p>
                    </div>
                  ...
                  <div className="flex justify-between">
                    <div className="w-2/3 flex flex-col gap-y-2">
                      <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                        <div
                          className="bg-[var(--clr-accent-900)] h-full rounded-full transition-all"
                          style={{ width: `60%` }}
                        ></div>
                      </div>
                      <div className="flex justify-between">
              ...
              <div className="flex bg-white p-4 gap-x-8">
                ...
                <div className="flex-1 flex flex-col gap-y-8">
                  ...
                  <div className="flex justify-between">
                    <div className="w-2/3 flex flex-col justify-center ">
                      <div className="flex divide-x-3">
                        <p className="inline-flex pr-2 items-center gap-x-1">
                          Start:{" "}
                          <strong className="text-[var(--clr-accent-900)]">
                            &nbsp;May 6
                          </strong>
                        </p>
                    ...
                    <div className="">
                      <p className="text-sm">Author</p>
                      <p className="text-lg text-[var(--clr-accent-900)]">
                        Amardeep
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="w-2/3 flex flex-col justify-center ">
                      <div className="flex divide-x-3">
                        ...
                        <span className="inline-flex pl-2 items-center gap-x-1">
                          ...
                          <a className="text-[var(--clr-accent-900)]" href="">
                            Certificate
                          </a>
                        </span>
                      </div>
            ...
            <div role="tabpanel" id="panel-4" aria-labelledby="tab-4"></div>
            <div role="tabpanel" id="panel-5" aria-labelledby="tab-5"></div>
          </div>
        </section> */}
      </div>
